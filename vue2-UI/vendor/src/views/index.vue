<template>
  <div class="app-container home">
    <el-row :gutter="20" style="margin:20px -10px">
      ...
      <el-col :xs="24" :sm="24" :md="9" :lg="9" style="margin-left: 10px;background-color: white;">
              ...
              <div style="float: right;width: 390px;">
                <div>
                  ...
                  <el-button size="mini" type="text"
                    ...
                    <router-link class="link-type" target="_blank"
                      :to="{ path: '/supplierdetails', query: { vendorId: this.userId}}"> 详情</router-link>
                  </el-button>
                </div>
                <p style="color: rgb(160,174,192);">联系人：<label>{{vendor.responsible}}</label> &nbsp;&nbsp;
                  联系电话：<label>{{vendor.responsiblePhone}}</label>
                </p>
              </div>
              <hr width="90%" />
              <div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      showUid(uid).then((response) => {
        console.log("显示我uid：" + uid);
