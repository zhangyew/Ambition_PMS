    ...
    <el-table :data="noticeBid" border style="width: 100%;text-align: center;">
      ...
      <el-table-column fixed="right" label="操作" width="200">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="medium "  v-if="zt!=-1"><router-link
                  class="link-type"
                  target="_blank"
                  :to="{ path: '/desk_insert', query: { tenderNoticeId: scope.row.tenderNoticeId, ProjectsId: scope.row.tenderNoticeProjectsId}}"
                > 可投标</router-link>
              </el-button>
          <!-- <el-button type="text" size="mini " v-if="zt!=-1">可投标</el-button> -->
          <el-button v-if="tb==1" size="mini" type="text" icon="el-icon-lock">投标成功</el-button>
