              ...
              <el-row>
                <el-col :span="12" class="grid-cell">
                  <el-form-item label="计划编码" prop="planClod" class="required label-right-align" style="width: 500px;">
                    <el-input v-model="formData.planClod" type="text" clearable :disabled="true" />
                  </el-form-item>
                </el-col>
                <el-col :span="12" class="grid-cell">
                ...
                <el-col :span="12" class="grid-cell">
                  <el-form-item label="供应商" prop="buyPlanVendorId" class="required label-right-align">
                    <el-select v-model="formData.buyPlanVendorId" :disabled="true" placeholdebuyTypeIdr="请选择供应商"
                      @change="changVendor()">
                ...
                <el-table :data="bcglXiangXiList" :row-class-name="rowClassName"
                  ...
                  <el-table-column label="物料编码" width="150">
                    <template slot-scope="scope">
                      ...
                      <GoodsView @Goods="getGoods" :gysId="formData.buyPlanVendorId"
...
<script>
  ...
  export default {
    ...
    created() {
      let buyId = this.$route.params.bid;
    ...
    methods: {
       ...
       */
      getInfo(buyId) {
        getBuy_plan(buyId).then(response => {
      ...
      submitTo() {
        ...
        updateBuy_plan(_this.formData).then(res => {
          console.log(res)
          if (res.code == 200) {
            _this.$modal.msgSuccess("修改成功");
            this.$router.push("/yz-shopping/buy_plan/index")
          } else {
