...
public class PublicVendorController extends BaseController
{
     ...
     * 查询供应商列表
     */
    @RequiresPermissions("pms.public:vendor:list")
    @GetMapping("/list")
     ...
     * 导出供应商列表
     */
    @RequiresPermissions("pms.public:vendor:export")
     ...
     * 获取供应商详细信息
     */
    @RequiresPermissions("pms.public:vendor:query")
     ...
     * 新增供应商
     */
    @RequiresPermissions("pms.public:vendor:add")
     ...
     * 修改供应商
     */
    @RequiresPermissions("pms.public:vendor:edit")
     ...
     * 删除供应商
     */
    @RequiresPermissions("pms.public:vendor:remove")
